  ...
  return (
    <div className="about-me" id="about">
      ...
      <div className="description" data-aos="fade-up">
        <p>🚀 I'm a <strong>second-year ECE student</strong> at <strong>Sathyabama Institute of Science and Technology (SIST)</strong> with a growing passion for <strong>web development</strong> and modern technologies.</p>
